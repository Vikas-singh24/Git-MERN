         ...
         {/* box 1 */}
                <div className="box1">
                  <div className="collections">
                    <h1>Collections</h1>
                    <p>
                     <h4> Explore curated lists of top restaurants, cafes, pubs, and bars in
                      Delhi NCR, based on trends </h4>  <span>All collections in Delhi NCR <FaCaretRight className="rightArrow" /></span>
                    </p>
                    <div className="places">
                                  <button className="btn prev" onClick={scrollLeft}><FaAngleLeft /></button>
                                  <button className="btn next" onClick={scrollRight}><FaAngleRight /></button>
                ...
                <div className="box2">
                  ...
                  <div className="options">
                    ...
                    <button className="pubs option">Pubs & Bars</button>
                    
                  </div>
        
                  <div className="offer">
                    <img id="off" src="https://b.zmtcdn.com/data/o2_assets/e067a1cf0d3fe27b366402b98b994e9f1716296909.png" alt="" />
        
                    <h1>Nightlife: Night clubs, pubs and bar in Delhi NCR</h1>
